...
struct cat2 { //Space
    ...
    //correct answer
    let rightAnswer = ["There was a drastic decrease in species variation between regions throughout the world", "The quick reproductive ability of pigs led to Europeans coming to the Americas since there was rarely a famine as a result of the large numbers of pigs", "Oxen were able to provide quicker and more efficient transportation as well as cultivate more land for crops", "The Columbian Exchange caused the extinction of many species of plants and animals", "Dutch", "Disease", "Protestant Reformation"]
